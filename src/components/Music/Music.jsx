        ...
        <div className="w-full sticky bottom-0 bg-slate-100">
            ...
            <div className=" flex justify-between gap-2 md:gap-4">
                <div className="flex items-center h-10 gap-6">
                    <button className="sm:w-6 sm:h-6 ml-6" onClick={handleClickMenu}>
                        <svg className="sm:w-6 sm:h-6 pointer-events-none svg-inline--fa fa-bars fa-w-14" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="bars" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"  data-v-42cab614="">
