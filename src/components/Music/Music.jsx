...
export default function Music(){
    ...
    return(
        <div className="w-screen sm:w-full sticky bottom-0 bg-slate-100">
            {menuVisible &&
            ...
            <div className=" flex justify-between gap-2 md:gap-4">
                <div className="flex items-center h-10 gap-6">
                    <button className="w-4 h-4 sm:w-6 sm:h-6 ml-6" onClick={handleClickMenu}>
                        <svg className="w-4 h-4 sm:w-6 sm:h-6 pointer-events-none svg-inline--fa fa-bars fa-w-14" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="bars" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"  data-v-42cab614="">
                            <path fill="currentColor" d="M16 132h416c8.837 0 16-7.163 16-16V76c0-8.837-7.163-16-16-16H16C7.163 60 0 67.163 0 76v40c0 8.837 7.163 16 16 16zm0 160h416c8.837 0 16-7.163 16-16v-40c0-8.837-7.163-16-16-16H16c-8.837 0-16 7.163-16 16v40c0 8.837 7.163 16 16 16zm0 160h416c8.837 0 16-7.163 16-16v-40c0-8.837-7.163-16-16-16H16c-8.837 0-16 7.163-16 16v40c0 8.837 7.163 16 16 16z" data-v-42cab614="" ></path>
                        </svg>
                    </button>
                    <button className="w-4 h-4 sm:w-6 sm:h-6" onClick={handleClickPlay}>
                        {playing
                        ?
                        <svg className="w-4 h-4 sm:w-6 sm:h-6 svg-inline--fa fa-pause fa-w-14" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="pause" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"   data-v-42cab614="">
                        ...
                        :
                        <svg className="w-4 h-4 sm:w-6 sm:h-6 ml-1 svg-inline--fa fa-play fa-w-14" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="play" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"  data-v-42cab614="">
                    ...
                    <button onClick={handleClickBack} className="w-2 h-2 sm:w-4 sm:h-4 md:ml-4 text-gray-700">
                    ...
                    <button className="w-2 h-2 sm:w-4 sm:h-4 text-gray-700" onClick={handleClickNext}>
                    ...
                    <button className="w-4 h-4 sm:w-6 sm:h-6 text-gray-700" onClick={handleClickVolumeOff}>
                    {
                        volumeoff
                        ?<svg aria-hidden="true" className="svg-inline--fa fa-volume-mute fa-w-16" focusable="false" data-prefix="fas" data-icon="volume-mute" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"  data-v-42cab614="">
                            <path fill="currentColor" d="M215.03 71.05L126.06 160H24c-13.26 0-24 10.74-24 24v144c0 13.25 10.74 24 24 24h102.06l88.97 88.95c15.03 15.03 40.97 4.47 40.97-16.97V88.02c0-21.46-25.96-31.98-40.97-16.97zM461.64 256l45.64-45.64c6.3-6.3 6.3-16.52 0-22.82l-22.82-22.82c-6.3-6.3-16.52-6.3-22.82 0L416 210.36l-45.64-45.64c-6.3-6.3-16.52-6.3-22.82 0l-22.82 22.82c-6.3 6.3-6.3 16.52 0 22.82L370.36 256l-45.63 45.63c-6.3 6.3-6.3 16.52 0 22.82l22.82 22.82c6.3 6.3 16.52 6.3 22.82 0L416 301.64l45.64 45.64c6.3 6.3 16.52 6.3 22.82 0l22.82-22.82c6.3-6.3 6.3-16.52 0-22.82L461.64 256z" data-v-42cab614=""></path>
                        </svg>
                        :
                    ...
                    <input className="hidden sm:block" min={0} max={100} value={volumen} onChange={handleChangeRange} type="range" name="" id="" />
                    <p className="text-black hidden md:block">{music[0].title}</p>
                </div>
                <div className="flex items-center h-10">
                    <button onClick={handleClickFullScreen} className="w-4 h-4 sm:w-6 sm:h-6 mr-6">
                        {fullScreen?
