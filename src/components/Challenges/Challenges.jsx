...
export default function Challenges(){
    ...
    return(
        <div id="challenge" className="w-screen sm:w-full flex justify-center items-center relative py-44 mb-16">
            <Arrow direction='top' id='#home' /> 
            <div  className="flex flex-col md:flex-row md:w-3/4 ">
                <h2 className="flex flex-col font-bold text-xl sm:text-3xl text-center md:text-left">
                ...
                <img className="md:w-96 md:h-60" src="images/challenge.webp" alt="grupo celebrando" />
            </div>
