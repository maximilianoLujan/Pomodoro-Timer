...
export default function Ask(){
    ...
    return(
        <div className="bg-primary w-full flex justify-center">
            <div className="w-5/6 sm:w-1/2 my-24">
                    ...
                    <footer className="w-max flex flex-col items-center text-white">
                        <div className="flex mb-2">
                            ...
                            <div className="flex items-center">
                                <svg className="w-6 h-6 mr-1" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="instagram" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="svg-inline--fa fa-instagram fa-w-14">
                                ...
                                <button>
                            <div className="flex items-center">
                                <svg className="w-6 h-6 mr-1" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="facebook" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="svg-inline--fa fa-facebook fa-w-16">
